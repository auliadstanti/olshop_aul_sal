                  ...
                  <div class="row">
                        <div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
                              ...
                              <div class="block1 hov-img-zoom pos-relative m-b-30">
                                    ...
                                    <div class="block1-wrapbtn w-size2">
                                          <!-- Button -->
                                          <a href="<?php echo base_url("Home/kategori/heels"); ?>" class="flex-c-m size2 m-text2 bg3 hov1 trans-0-4">
                                                Heels
                                          </a>
                                    </div>
                              </div>
                              ...
                              <div class="block1 hov-img-zoom pos-relative m-b-30">
                                    ...
                                    <div class="block1-wrapbtn w-size2">
                                          <!-- Button -->
                                          <a href="<?php echo base_url("Home/kategori/wedges"); ?>" class="flex-c-m size2 m-text2 bg3 hov1 trans-0-4">
                                                Wedges
                                          </a>
                                    </div>
                              </div>
                        ...
                        <div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
                              ...
                              <div class="block1 hov-img-zoom pos-relative m-b-30">
                                    ...
                                    <div class="block1-wrapbtn w-size2">
                                          <!-- Button -->
                                          <a href="<?php echo base_url("Home/kategori/shoes"); ?>" class="flex-c-m size2 m-text2 bg3 hov1 trans-0-4">
                                                Shoes
                                          </a>
                                    </div>
                              </div>
                              ...
                              <div class="block1 hov-img-zoom pos-relative m-b-30">
                                    ...
                                    <div class="block1-wrapbtn w-size2">
                                          <!-- Button -->
                                          <a href="<?php echo base_url("Home/kategori/Sandals"); ?>" class="flex-c-m size2 m-text2 bg3 hov1 trans-0-4">
                                                Sandals
                                          </a>
                                    </div>
                              </div>
                        ...
                        <div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
                              ...
                              <div class="block1 hov-img-zoom pos-relative m-b-30">
                                    ...
                                    <div class="block1-wrapbtn w-size2">
                                          <!-- Button -->
                                          <a href="<?php echo base_url("Home/kategori/boots"); ?>" class="flex-c-m size2 m-text2 bg3 hov1 trans-0-4">
                                                Boots
                                          </a>
                                    </div>
                              </div>
                              ...
                              <div class="block2 wrap-pic-w pos-relative m-b-30">
                                    ...
                                    <div class="block2-content sizefull ab-t-l flex-col-c-m">
                                          ...
                                          <div class="w-size2 p-t-25">
                                                <!-- Button -->
                                                <a href="<?php echo base_url('Login/register') ?>" class="flex-c-m size2 bg4 bo-rad-23 hov1 m-text3 trans-0-4">
                                                      Sign Up
                                                </a>
                                          </div>
                                    </div>
